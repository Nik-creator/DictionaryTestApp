...
const StarIcon = memo(({ id }: OwnProps) =>  {
  const { isFavorite, handleClick } = useFavorites(id)

  return (
    <svg className={styles.icon} width="24" height="22" viewBox="0 0 24 22" fill="none" onClick={handleClick}>
      <path
